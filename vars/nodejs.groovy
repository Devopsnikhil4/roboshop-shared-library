def call() {
    node {
        git branch: 'main', url: 'https://github.com/Devopsnikhil4/cart.git'
        env.APP_TYPE="nodejs"
        common.lintChecks()
            ...
            stage('Upload Artifacts') {
                ...
                steps {
                    sh  '''
                        ...
                        curl -f -v -u ${NEXUS_USR}:${NEXUS_PSW} --upload-file ${COMPONENT}-${TAG_NAME}.zip  http://107.20.6.151:8081/repository/${COMPONENT}/${COMPONENT}-${TAG_NAME}.zip
